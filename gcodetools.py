...
class Gcodetools(inkex.EffectExtension):
    ...
    def add_arguments(self, pars):
        ...
        add_argument("-p", "--feed", type=float, default="4.0", help="Feed rate (XY) in unit/min")
        add_argument("-pf", "--penetration_feed", type=float, default="4.0", help="Penetration feed rate (Z) in unit/min")
        add_argument("-ds", "--depth_step", type=float, default="4.0", help="Depth step in unit")
    ...
    def tab_tools_library(self, layer=None):
        ...
        elif self.options.tools_library_type == "pen":
            tool = {
                "name": "Pen",
                "id": "Pen 0001",
                "diameter": 10,
                ...
                "penetration feed": self.options.penetration_feed,
                "depth step": self.options.depth_step,
                "tool change gcode": " "
            }    
